...
export const Logo: React.FC = () => {
  ...
  const logoList = [
    ...
    'republica-portuguesa-colors-2',
    'republica-portuguesa',
    'republica-portuguesa-vertical-colors',
    'republica-portuguesa-vertical-colors-2',
    'republica-portuguesa-vertical',
    'acss-vertical',
    'acss-horizontal',
    'dgs',
    'dgs-colors',
